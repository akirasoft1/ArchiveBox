...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='snapshot',
            name='output_dir',
            field=models.FilePathField(blank=True, default=None, match='.*', null=True, path=pathlib.PurePosixPath('/data/archive'), recursive=True),
        ),
        migrations.AddField(
            model_name='snapshot',
            name='retry_at',
        ...
        migrations.AlterField(
            model_name='snapshot',
            name='timestamp',
            field=models.CharField(db_index=True, editable=False, max_length=32, unique=True, validators=[core.models.validate_timestamp]),
        ),
        migrations.AlterField(
            model_name='tag',
            name='created_by',
            field=models.ForeignKey(default=archivebox.base_models.base.get_or_create_system_user_pk, on_delete=django.db.models.deletion.CASCADE, related_name='tag_set', to=settings.AUTH_USER_MODEL),
        ),
    ]
